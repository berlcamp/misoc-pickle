      ...
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-md p-8">
        ...
        <section className="mb-8">
          ...
          <p className="mt-4 text-gray-700">
            <strong>Additional Notes:</strong> The intent of the Novice Category
            is to provide a welcoming environment for true beginners to compete
            and learn without facing experienced or highly skilled players.
          </p>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700">
            Must be at least 45 years old on or before{' '}
            <strong>Nov. 8, 2025.</strong>
          </p>
        </section>
